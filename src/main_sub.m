...
maeVarNames = { ...
    ...
    'RegularizedParticleFilter', 'MCMCResamplingParticleFilter', 'AuxiliaryParticleFilter', ...
    'RougheningPriorEditingParticleFilter', 'EKFParticleFilter', 'AdaptiveParticleFilter', ...
    'KLDAdaptiveParticleFilter', 'IAEMapAdaptiveParticleFilter'};
